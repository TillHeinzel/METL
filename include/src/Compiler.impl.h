...
namespace metl
{
	namespace internal
	{
		...
		template <class LiteralConverters, class ... Ts>
		void Compiler<LiteralConverters, Ts...>::setOperatorPrecedence(const std::string& op, unsigned precedence,
		...
		template <class LiteralConverters, class ... Ts>
		void Compiler<LiteralConverters, Ts...>::setUnaryOperatorPrecedence(const std::string& op, unsigned precedence)
		{
			internal::insert_or_emplace(unaryCarriers_, op, opCarrier{ op, precedence, ASSOCIATIVITY::RIGHT, true });
		}

		template <class LiteralConverters, class ... Ts>
		void Compiler<LiteralConverters, Ts...>::setOperator(const std::string& token,
		...
		template <class LiteralConverters, class ... Ts>
		void Compiler<LiteralConverters, Ts...>::setUnaryOperator(const std::string& token, TYPE paramType,
		...
		template <class LiteralConverters, class ... Ts>
		void Compiler<LiteralConverters, Ts...>::setFunction(const std::string& token,
		...
		template <class LiteralConverters, class ... Ts>
		void Compiler<LiteralConverters, Ts...>::setCast(const TYPE from, const TYPE to, const CastImpl<Expression>& fs)
		{
		...
		template <class LiteralConverters, class ... Ts>
		void Compiler<LiteralConverters, Ts...>::setSuffix(const std::string& token, const TYPE from, const CastImpl<Expression>& conversion)
		{
		...
		template <class LiteralConverters, class ... Ts>
		void Compiler<LiteralConverters, Ts...>::addConstantOrVariable(const std::string& token, const Expression& val)
		{
